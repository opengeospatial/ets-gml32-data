...
public class CommonFixture {
     ...
     */
    public static final String ROOT_PKG_PATH = "/org/opengis/cite/gml32/data/";
    /**
    ...
    public void initCommonFixture(ITestContext testContext) {
        ...
        obj = testContext.getSuite().getAttribute(SuiteAttribute.TEST_SUBJ_FILE.getName());
        if (null == obj) {
            throw new SkipException("Test subject (File) not found in ITestContext.");
        }
    }
