...
`org.opengis.cite.gml32.data`. A conformance class corresponds to a &lt;test&gt; element, each 
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>org.opengis.cite.gml32.data.level1.*</td>
    </tr>
    <tr>
      <td>Conformance Level 2</td>
      <td>org.opengis.cite.gml32.data.level2.*</td>
    </tr>
  </tbody>
</table>
